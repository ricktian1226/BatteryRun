...
func (api *XYAPI) OperationRoleInfoListRequest(req *battery.RoleInfoListRequest, resp *battery.RoleInfoListResponse) (err error) {
	...
	failReason, err = api.SendToTransaction(uid, xybusiness.BusinessCode_RoleInfoList, req, resp)
