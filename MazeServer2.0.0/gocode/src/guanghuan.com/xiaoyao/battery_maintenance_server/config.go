...
func ParseConfigFile(businessCollection *xybusiness.BusinessCollections) error {
	...
	xybusiness.ParseBusinessCollections(configs, businessCollection)
...
func initServerConfig(businessColections *xybusiness.BusinessCollections) bool {
	...
	if err := ParseConfigFile(businessColections); err != nil {
		return false
	}
