...
func (bl *BeeLogger) Trace(format string, v ...interface{}) {
	msg := fmt.Sprintf("[Trace] "+format, v...) //源码中提示为[T]修改为[Trace]能更好地识别 modified by tianguimao 2014.05.14
	bl.writerMsg(LevelTrace, msg)
}

// log debug level message.
func (bl *BeeLogger) Debug(format string, v ...interface{}) {
	msg := fmt.Sprintf("[Debug] "+format, v...) //源码中提示为[D]修改为[Debug]能更好地识别 modified by tianguimao 2014.05.14
	bl.writerMsg(LevelDebug, msg)
}

// log info level message.
func (bl *BeeLogger) Info(format string, v ...interface{}) {
	msg := fmt.Sprintf("[Info] "+format, v...) //源码中提示为[I]修改为[Info]能更好地识别 modified by tianguimao 2014.05.14
	bl.writerMsg(LevelInfo, msg)
}

// log warn level message.
func (bl *BeeLogger) Warn(format string, v ...interface{}) {
	msg := fmt.Sprintf("[Warn] "+format, v...) //源码中提示为[W]修改为[Warn]能更好地识别 modified by tianguimao 2014.05.14
	bl.writerMsg(LevelWarn, msg)
}

// log error level message.
func (bl *BeeLogger) Error(format string, v ...interface{}) {
	msg := fmt.Sprintf("[Error] "+format, v...) //源码中提示为[E]修改为[Error]能更好地识别 modified by tianguimao 2014.05.14
